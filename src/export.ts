export function generateCssFromStyles(styleData: any[]): string {
  const exsitingTailwindCss = [
    ...
    '.text-gray-50', '.bg-gray-50', '.fill-gray-50', '.border-gray-50',
    '.text-gray-100', '.bg-gray-100', '.fill-gray-100', '.border-gray-100',
    '.text-gray-200', '.bg-gray-200', '.fill-gray-200', '.border-gray-200',
    '.text-gray-300', '.bg-gray-300', '.fill-gray-300', '.border-gray-300',
    '.text-gray-400', '.bg-gray-400', '.fill-gray-400', '.border-gray-400',
    '.text-gray-500', '.bg-gray-500', '.fill-gray-500', '.border-gray-500',
    '.text-gray-600', '.bg-gray-600', '.fill-gray-600', '.border-gray-600',
    '.text-gray-700', '.bg-gray-700', '.fill-gray-700', '.border-gray-700',
    '.text-gray-800', '.bg-gray-800', '.fill-gray-800', '.border-gray-800',
    '.text-gray-900', '.bg-gray-900', '.fill-gray-900', '.border-gray-900',
